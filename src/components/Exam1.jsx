import { Exam1 } from "../App";

export default App; // 클래스형 컴포넌트 Exam1 정의
...
export class Exam1 extends Component {
  ...
  constructor(props) {
    ...
    this.state = { count: }; // state(상태)중 count 상태값을 0으로 초기화.
 ...
 // 생명주기 코드
  // 컴포넌트가 처음 화면에 나타났을 때
  componentDidMount() {
    console.log("compoentDidMount : 마운트 완료");
  }
...
render() {
  return (
    <div>
      ...
      <h2>부모로 부터 전달받은 값 : {this.props.jaei} {this.props.test}</h2>
    </div>
    );
  }
}
